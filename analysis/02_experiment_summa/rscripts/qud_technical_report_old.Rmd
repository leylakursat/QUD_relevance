...
df = read.csv("~/Desktop/repos/QUD_relevance/analysis/02_experiment_summa/data/results_formatted.csv")
demo = read.csv("~/Desktop/repos/QUD_relevance/analysis/02_experiment_summa/data/subject_info_merged.csv")
...
#native language , #70 didn't answer, #109 is non-native, 1 person excluded 
lang = demo %>%
...
#practice trials, 8 people excluded 
practice = df %>% 
