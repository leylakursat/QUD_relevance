---
title: 'Experiment 7: some any-QUD (merge with all)'
...
df_all = read.csv("05_results_formatted.csv", header = TRUE)
demo_all = read.csv("05_subject_info.csv", header = TRUE)

df_any = read.csv("07_results_formatted.csv", header = TRUE)
demo_any = read.csv("07_subject_info.csv", header = TRUE)
...
#write.csv(critical, file = "experiment7_critical.csv")
